...
# 이 코드는 다음과 같은 가설을 검정합니다:

# 귀무 가설(H0): 코로나에 걸린 사람들의 수축기 혈압이 정상인의 혈압과 같다. ("Collected Samples are not biased")
# 대립 가설(H1): 코로나에 걸린 사람들의 수축기 혈압이 정상인의 혈압보다 높다. ("The sample collected will be higher than the population")

# 만약 p-value가 0.05보다 작다면, 5%의 유의 수준에서 귀무 가설을 기각하고 대립 가설을 선택합니다. 
# 이는 코로나에 걸린 사람들의 수축기 혈압이 정상인의 혈압보다 통계적으로 유의미하게 높다는 것을 의미합니다.

# 반대로, p-value가 0.05보다 크다면, 5%의 유의 수준에서 귀무 가설을 기각하지 않습니다. 
# 이는 코로나에 걸린 사람들의 수축기 혈압이 정상인의 혈압보다 통계적으로 유의미하게 높다고 할 수 없다는 것을 의미합니다.
